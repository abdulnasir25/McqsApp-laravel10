...
<div class="col-md-9">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('questions.store') }}" id="addQst" method="POST">
                @csrf
                
                <div class="form-group">
                    <label for="question" class="form-label">Question Title</label>
                    <input type="text" name="question" class="form-control" id="question" required placeholder="What is your question?">
                </div>
                
                <div class="form-group">
                    <label for="question_marks" class="form-label">Question Marks</label>
                    <input type="text" name="question_marks" class="form-control" id="question_marks" required placeholder="10">
                </div>
        ...
        $('#addQst').submit(function(e) {
            ...
            if($('.answers').length < 2) {
                ...
                for (let i = 0; i < $('.is_correct').length; i++) {
                    ...
                    if (isCorrect) {
                        // Submit the form
                        document.getElementById("addQst").submit();
                        return false;
                    } else {
